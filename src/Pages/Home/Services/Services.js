...
const servicesData = [
  ...
  },
  {
    ...
    description:
      "Be it Web application services or API development in any domain, our team of dedicated developers has expertise in delivering power-packed solutions.Developers",
    serviceAnimation: {
      hidden: {
        x: "-100vw",
        opacity: 0,
