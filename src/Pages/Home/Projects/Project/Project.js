  ...
  return (
    ...
    >
      ...
      <div className="project_imageandsocial w-full">
        <div className="project_cardbox overflow-hidden dark:border-white w-full bg-cover bg-center bg-opacity-10"
        >
          <img src={project?.image} alt="" />
        </div>
        <div>
          <div className="project_socialicon dark:border-white" title="FontEnd Code" >
            <a
              rel="noreferrer"
              target="_blank"
          ...
          </div>
          {
            ...
            <div title="Backend Code" className="project_socialicon dark:border-white">
              <a
                rel="noreferrer"
                target="_blank"
                className="dark:text-white"
      ...
      <div className="project_cardbottom">
        <p className="dark:text-gray-400">{project?.project_blog}</p>
      </div>
      <div className="chakra_stack justify-start mt-3 mr-16 flex-wrap">
        {project?.technology_feature?.map((tag, index) => (
          <div key={index}>
